        ...
        <div className="flex justify-between h-20 md:h-16 items-center">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <Link href={`/${locale}/`} className="flex items-center gap-4">
              {locale === 'ar' ? (
                <>
                  <span className="text-lg min-[1440px]:text-2xl text-foreground/80 whitespace-nowrap">شهداء غزة</span>
                  <span className="text-base min-[1440px]:text-xl font-bold text-foreground whitespace-nowrap">Gaza Deaths</span>
                </>
              ) : (
                <>
                  <span className="text-base min-[1440px]:text-xl font-bold text-foreground whitespace-nowrap">Gaza Deaths</span>
            ...
            {mounted ? (
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent side="top" className="pb-8">
                  <SheetHeader>
                    <SheetTitle>Gaza Deaths</SheetTitle>
                  </SheetHeader>
